    ...
    public class TrainersController : Controller
    {
        ...
        public string Add(string firstName, string lastName, string profilePic, string bGrnd)
        {
            ...
            try
            {
                ...
                ITrainerRepository tRepo = new TrainerRepository(new FLDataDataContext());

                Trainer coach = new Trainer() { AccountId = aId, PhotoId = pId,Background=bGrnd };
                var tId = tRepo.addTrainer(coach);
